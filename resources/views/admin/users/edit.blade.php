...
<div class="max-w-2xl space-y-6">
    <div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="bg-white rounded-none border border-slate-200 shadow-sm p-6 space-y-4" enctype="multipart/form-data">
            @csrf @method('PUT')
